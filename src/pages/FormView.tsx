...
const FormView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main className="container py-6 px-4 md:px-6 max-w-5xl">
        <motion.div
            ...
            <TabsContent value="form" className="mt-6 space-y-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  {/* Form fields will vary based on form type, here's a generic example */}
            ...
            <TabsContent value="analysis" className="mt-6 space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Default analysis for other form types */}
