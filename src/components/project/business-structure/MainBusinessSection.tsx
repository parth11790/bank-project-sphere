...
const MainBusinessSection: React.FC<MainBusinessSectionProps> = ({
  ...
  return <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={handleViewDetails}>
      <CardHeader>
      ...
      <CardContent>
        {project.main_business ? <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                {project.main_business.description && <div>
