  ...
  return <div className="space-y-6">
      ...
      {fields.map((field, index) => <Card key={field.id}>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField control={form.control} name={`education.${index}.school_name`} render={({
          field
        }) => <FormItem>
            ...
            <FormField control={form.control} name={`education.${index}.degree_certification`} render={({
          field
        }) => <FormItem>
            ...
            <FormField control={form.control} name={`education.${index}.area_of_study`} render={({
          field
        }) => <FormItem>
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <FormField control={form.control} name={`education.${index}.start_date`} render={({
              field
            }) => <FormItem>
                ...
                <FormField control={form.control} name={`education.${index}.end_date`} render={({
              field
            }) => <FormItem>
