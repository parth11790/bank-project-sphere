      ...
      {fields.map((field, index) => <Card key={field.id}>
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              {fields.length > 3 && <Button type="button" variant="outline" size="sm" onClick={() => remove(index)}>
                  <Trash2 className="h-4 w-4" />
                </Button>}
            </div>
          </CardHeader>
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField control={form.control} name={`professional_references.${index}.reference_name`} render={({
          field
        }) => <FormItem>
            ...
            <FormField control={form.control} name={`professional_references.${index}.relationship`} render={({
          field
        }) => <FormItem>
            ...
            <FormField control={form.control} name={`professional_references.${index}.phone_number`} render={({
          field
        }) => <FormItem>
            ...
            <FormField control={form.control} name={`professional_references.${index}.email_address`} render={({
          field
        }) => <FormItem>
